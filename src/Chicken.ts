...
import { LocalPlayer, rand, SetEmote } from "./main";
...
import { FailingAction } from "./ai/actions/FailingAction";
...
export class HasDaylight extends Condition {
  ...
  update() {
    return this.blackboard.get("hasDaylight", false)
    ...
    this.ai = new BehaviorTree(
      new ActiveSelector([
        ...
        new FreshSequence([
          ...
          new AccelerateAwayFromNearestTag(
            this,
            "humanoid",
            125,
            200,
